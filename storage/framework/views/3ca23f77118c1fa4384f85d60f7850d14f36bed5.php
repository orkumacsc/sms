		...
		<div class="row">
			<div class="table-responsive col-sm-12">
				<table id="" class="table table-bordered nowrap">
					...
					<tbody>
						<?php $__currentLoopData = $schoolArms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $schoolArm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								<td><?php echo e($key + 1); ?></td>
								<td><?php echo e($schoolArm->arm_name); ?>

								</td>
								<td>
									<input type="checkbox" id="<?php echo e($schoolArm->id); ?>" name="arm_id[]" value="<?php echo e($schoolArm->id); ?>"
										class="checkboxes">
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="form-group">
					<h5>School Disciplines<span class="text-danger">*</span></h5>
					<div class="controls">
						<select name="class_id" id="class_id" required class="form-control p-10">
							...
							<?php $__currentLoopData = $disciplines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $discipline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option value="<?php echo e($discipline->id); ?>"><?php echo e($discipline->name); ?>
