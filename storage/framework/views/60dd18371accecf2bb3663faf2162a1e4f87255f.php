            ...
            <ul class="nav navbar-nav">
                <li class="d-flex align-items-center" style="justify-content: flex-start;">
                    <h5 class="mb-0" style="text-align: left;">
                        <?php echo e($fullName); ?><?php echo e($staffId ? ' | ' . $staffId : ''); ?>
...
</header><?php /**PATH C:\xampp\htdocs\gospelcollege\portal.gospelschools.sch.ng\resources\views/Teachers/body/header.blade.php ENDPATH**/ ?>