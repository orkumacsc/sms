					...
					<div class="row">
						...
						<div class="col-12">
							...
							<div class="row">
								...
								<div class="col-sm-2">
									<img src="<?php echo e(url('backend/images/school_logo.png')); ?>" >
								</div>
								<div class="col-sm-8 text-center">
									<h2>GOSPEL INTERNATIONAL COLLEGE, ZAKI-BIAM</h2>
								...
								<div class="col-sm-2">
									<img src="<?php echo e(url('backend/images/Coat_of_arms_of_Nigeria.png')); ?>" >
								</div>
								...
								<div class="col-sm-4">
									<table class="table table-bordered">
										<thead class="text-center">
											<tr>
												<th colspan="2"><h4><?php echo e($Print->surname.', '.$Print->firstname.' '.$Print->middlename); ?></h4></th>															
											</tr>
											<tr>
										...
										<tbody class="text-left">
											<tr>
												<th>GENDER</th>
												<td><?php echo e($Print->gendername); ?></td>
											</tr>
											<tr>
												<th>ADMISSION NO</th>
												<td><?php echo e($Print->admission_no); ?></td>
											</tr>
											<tr>
												<th>DATE OF BIRTH</th>
												<td><?php echo e(\Carbon\Carbon::parse($Print->date_of_birth)->format('d M., Y')); ?></td>
											</tr>
											<tr>
												<th>HOUSE</th>
								...
								<table class="table table-bordered">										
										<tbody>
											<tr class="text-center" style="padding:2%">
												...
												<img src="<?php echo e(url('storage/'.$Print->passport)); ?>" >
												</td>												
											</tr>
											<tr>
												<th>CLASS ADMITTED INTO</th>
												<td><?php echo e($Print->classname); ?></td>
																								
											</tr>
											<tr>
												<th>SESSION ADMITTED</th>
												<td>2022/2023 ACADEMIC SESSION</td>
											</tr>
											...
											<tr>
												<th>FULL NAME</th>
												<td><h4><?php echo e($Print->surname); ?></h4></td>
											</tr>											
											<tr>
												<th>CONTACT</th>
												<td></td>
							...
							<div class="row text-justify p-50 pl-2-60">
								...
								<div>
									<h3 class="col text-center mb-30"><b>OFFER OF PROVISIONAL ADMISSION INTO 2022/2023 ACADEMIC SESSION</b></h4>
									...
									<h2>
										<b>RESUMPTION DATE : 12<sup>TH</sup> SEPTEMBER, 2022</b>
									</h2>
									...
									<h3><b>USERNAME:</b> <?php echo e($Print->admission_no); ?></h2>
...
<?php echo $__env->make('Admission_Officer.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gospelcollege\portal.gospelschools.sch.ng\resources\views/backend/admin/StudentManagement/admission_letter.blade.php ENDPATH**/ ?>