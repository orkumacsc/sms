						...
						<div class="col-12">
								...
								<div class="col-sm-4">
									<table class="table table-bordered">
										<thead class="text-center">
											<tr>
												<th colspan="2"><h4>{{ $Print->surname.', '.$Print->firstname.' '.$Print->middlename }}</h4></th>															
											</tr>
											<tr>
										...
										<tbody class="text-left">
											...
											<tr>
												<th>DATE OF BIRTH</th>
												<td>{{ \Carbon\Carbon::parse($Print->date_of_birth)->format('d M., Y') }}</td>
											</tr>
											<tr>
												<th>HOUSE</th>
												<td>{{ $Print->name }}</td>
								...
								<table class="table table-bordered">										
										<tbody>
											<tr class="text-center" style="padding:2%">
												...
												<img src="{{ url('storage/'.$Print->passport) }}" >
												</td>												
											</tr>
											<tr>
												<th>CLASS ADMITTED INTO</th>
												<td>{{ $Print->classname }}</td>
							...
							<div class="row text-justify p-50 pl-2-60">
								...
								<div>
									...
									<h3><b>USERNAME:</b> {{ $Print->admission_no }}</h2>
