<form method="post" action="{{ route('staff.teaching.assign') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ currentAcademicSession()->name }}" readonly>
