            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <h5 class="text-center">
                        <strong>
                            <u>ANNUAL CONTINUOUS ASSESSMENT REPORT |
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            ...
                                            <td rowspan="3" class="vertical">ANNUAL CLASS HIGHEST</td>
                                            <td rowspan="3" class="vertical">ANNUAL CLASS LOWEST</td>
                                            <td rowspan="3" class="vertical">ANNUAL SUBJECT POSITION</td>
