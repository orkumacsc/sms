	  ...
	  <div class="container-full">
		...
		<section class="content">
			<div class="row"> 
				...
				<div class="col-xl-2 col-6 col-12">
				...
				<div class="col-xl-2 col-6 col-12">
					...
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								<p class="text-mute mt-20 mb-0 font-size-16">Students Admission List</p>
								<h3 class="text-white mb-0 font-weight-500"></h3>
							</div>
						</div>
					</div>
				...
				<div class="col-xl-2 col-6 col-12">
					...
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								<p class="text-mute mt-20 mb-0 font-size-16">Promote Students</p>
								<h3 class="text-white mb-0 font-weight-500"></h3>
							</div>
						</div>
					</div>
